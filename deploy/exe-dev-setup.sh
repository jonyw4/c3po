...
#   - GEMINI_API_KEY set in environment (Google AI Studio)
...
if [ -z "${GEMINI_API_KEY:-}" ]; then
    echo "WARNING: GEMINI_API_KEY not set. Set it before starting the gateway."
...
GEMINI_API_KEY=${GEMINI_API_KEY:-CHANGE-ME}
